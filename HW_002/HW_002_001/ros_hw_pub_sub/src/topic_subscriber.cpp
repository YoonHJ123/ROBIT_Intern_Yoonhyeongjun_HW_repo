...
{
ROS_INFO("recieve stamp = %d", msg->stamp.sec); // stamp.sec 메시지를 표시한다
ROS_INFO("recieve data1 = %d", msg->data1); // stamp.nsec 메시지를 표시한다
ROS_INFO("recieve data2 = %d", msg->data2); // data 메시지를 표시한다
ROS_INFO("recieve msg = %s", msg->message.c_str()); // data 메시지를 표시한다
}
